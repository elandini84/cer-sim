...
def generate_launch_description():
    ...
    robot_xacro_decl = DeclareLaunchArgument(
            'robot_xacro_name',
            default_value='cer_sim_neck_pos_vel.urdf.xacro',
            description='The robot xacro file name')
    controllers_file_decl = DeclareLaunchArgument(
            'controllers_file',
            default_value='cer_sim_ros2_control_neck_pos_vel.yaml',
